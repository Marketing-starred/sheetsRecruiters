...
$(document).ready(function() {
    ...
    <header>\
    <div id="nav-logo"><a href="/"><img src="https://cdn.sft.com/assets/sheets-logo-white.png" alt="SFR logo"></a></div>\
    <div>\
    ...
    <header>\
        <div id="nav-logo-mob"><a href="/"><img src="https://cdn.sft.com/assets/logo-favicon.svg" alt="SFR logo"></a></div>\
        <div>\
    ...
    <div class="color--white p-l-80 w-80">\
        <div class="footer-logo"><img src="https://cdn.sft.com/assets/starred-white-full.png" alt="Starred"></div>\
